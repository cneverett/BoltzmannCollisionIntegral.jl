...
- Evaluate the emission and absorption spectrum using the [`RPointLogMomentum!(pu,pl,pv,num`](@ref) function for serial and SpectralEvaluateSerial(userInputMultiThread) for multithread. 
