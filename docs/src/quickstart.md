...
- Evaluate the emission and absorption spectrum using the [`BinaryInteractionSpectra.RPointLogMomentum!`](@ref) function for serial and SpectralEvaluateSerial(userInputMultiThread) for multithread. 
