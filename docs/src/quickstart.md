...
- Evaluate the emission and absorption spectrum using the [`BinaryInteractionSpectra.SpectralEvaluateSerial`](@ref) function for serial and SpectralEvaluateSerial(userInputMultiThread) for multithread. 
