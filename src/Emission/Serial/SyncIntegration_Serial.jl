...
"""
function SyncEvaluateSerial(userSyncInputSerial::Tuple{Tuple{String,String,Float64,Float64,Float64,Float64, Float64,Float64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64, Float64},Int64,Int64,String,String})

    # ======= Load User Parameters ======= #

        (Parameters,numTiter,numSiter,fileLocation,fileName) = userSyncInputSerial;
