...
function MonteCarloArraysBinary(Parameters::Tuple{String,String,String,String,Float64,Float64,Float64,Float64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64})
    ...
    GainTotal3::Array{Float64,9} = zeros(Float64,(p3_num+1),u3_num,h3_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num); 
    GainTotal4::Array{Float64,9} = zeros(Float64,(p4_num+1),u4_num,h4_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num); 
    ...
    GainTally3::Array{UInt32,9} = zeros(UInt32,(p3_num+2),u3_num,h3_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
    GainTally4::Array{UInt32,9} = zeros(UInt32,(p4_num+2),u4_num,h4_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
    LossTally::Array{UInt32,6} = zeros(UInt32,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);

    GainMatrix3::Array{Float64,9} = zeros(Float64,(p3_num+1),u3_num,h3_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
    GainMatrix4::Array{Float64,9} = zeros(Float64,(p4_num+1),u4_num,h4_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
...
function OldMonteCarloArraysBinary(Parameters::Tuple{String,String,String,String,Float64,Float64,Float64,Float64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64, Float64,Float64,String,Int64,String,Int64,String,Int64},filePath::String)
    ...
    if fileExist
        ...
        OldGainTally3::Array{UInt32,9} = zeros(UInt32,(p3_num+1),u3_num,h3_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
        OldGainTally4::Array{UInt32,9} = zeros(UInt32,(p4_num+1),u4_num,h4_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
        OldLossTally::Array{UInt32,6} = zeros(UInt32,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
        OldGainMatrix3::Array{Float64,9} = zeros(Float64,(p3_num+1),u3_num,h3_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
        OldGainMatrix4::Array{Float64,9} = zeros(Float64,(p4_num+1),u4_num,h4_num,p1_num,u1_num,h1_num,p2_num,u2_num,h2_num);
