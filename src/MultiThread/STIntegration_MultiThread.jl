...
function SpectraEvaluateMultiThread(userInputMultiThread::Tuple{String,String,String,String,Float64,Float64,Int64,Float64,Float64,Int64,Float64,Float64,Int64,Float64,Float64,Int64,Int64,Int64,Int64,Int64,Int64,Int64,Int64,String,String})
    ...
    (name1,name2,name3,name4,p3l,p3u,nump3,p4l,p4u,nump4,p1l,p1u,nump1,p2l,p2u,nump2,numt3,numt4,numt1,numt2,numTiterPerThread,numSiterPerThread,nThreads,fileLocation,fileName) = userInputMultiThread
    ...
    # ===== Run MonteCarlo Integration ==== #
        ...
        # Set up workers
        workers = [STMonteCarloAxi_MultiThread!(SAtotal3,SAtotal4,TAtotal,SAtally3,SAtally4,TAtally,ArrayOfLocks,p3Max,p4Max,t3MinMax,t4MinMax,sigma,dsigmadt,Parameters,numTiterPerThread,numSiterPerThread) for _ in 1:nThreads]
