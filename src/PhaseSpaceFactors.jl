function PhaseSpaceFactors!(SMatrix::Array{Float32,6},TMatrix::Array{Float32,4},p3val::Vector{Float32},t3val::Vector{Float32},p1val::Vector{Float32},t1val::Vector{Float32},p2val::Vector{Float32},t2val::Vector{Float32})
    ...
    for ii in 1:numt2
        for jj in 1:nump2
            for kk in 1:numt1
                for ll in 1:nump1
                    for mm in 1:numt3
                        SMatrix[2,mm,ll,kk,jj,ii] *= #= (cospi(t3val[mm])-cospi(t3val[mm+1])) =# 1/(p3val[nump3+1]*10^(log10(p3val[nump3+1])-log10(p3val[nump3]))-p3val[nump3+1])  # d^3pvec3
...
function PhaseSpaceFactors2!(SMatrix::Array{Float32,6},TMatrix::Array{Float32,4},t3val::Vector{Float32},p1val::Vector{Float32},t1val::Vector{Float32},p2val::Vector{Float32},t2val::Vector{Float32})
